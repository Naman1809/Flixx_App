...
const global = {
  ...
  api:{
    apiKey: 'c74ca772bda1725970fe8cb3fa875379',
...
async function displayMovieDetails() {
  // with this we will get the id you can check it by using the console log
...
// funciton to reate and display pagination for search
